...
3. 향상된 for문을 사용하여 library에 저장된 모든 책의 제목과 저자를 출력하세요.*/
        ...
        Book book1 = new Book("책1" , "유재석");
        Book book2 = new Book("책2" , "강호동");
        Book book3 = new Book("책3" , "박명수");

        library.add(book1.getTitle() + book1.getAuthor());
        library.add(book2.getTitle() + book2.getAuthor());
        library.add(book3.getTitle() + book3.getAuthor());
