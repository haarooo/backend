...
public class Exam01 {
    static void main() {
        ...
        //2. 목적 : 클래스 정의할때 변수 타입 정하지 않고 인스턴스(객체) 생성할때 타입 정한다
        //3. 사용법
        /*
            //제네릭 타입명은 대문자로 한다.
            //여러개 가능하다
            // 제네릭 타입에 대입되는 타입은 기본타입 안된다.
                //int -> integer
        ...
        */
        ...
        //ArrayList 컬렉션 프레임워크
        ArrayList<String> list = new ArrayList<>(); //ArrayList안에서 제네릭 타입을 String 사용
        //ArrayList<Dto> list2 = new ArrayList<>(); //                           Dto 사용
