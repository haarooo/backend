...
public class Exam02 {
    public static void main(String[] args) {
        ...
        //2. 종류
            ...
            //(default) : 같은/하위 패키지에서만 호출 가능 접근제한자가 없을 경우 자동
        ...
        A a =new A();
        System.out.println("a.공 = " + a.공개변수);
        //System.out.println("a.비공개변수 = " + a.비공개변수);
        //System.out.println("a.일반변수 = " + a.일반변수);


        //5. import : 다른 패키지의 클래스 호출
        // 자동완성시 자동으로 최상단에 import
        //--->day07 폴더내 package1 폴더내 A 클래스 가져옴
        //import java.util.Scanner
        //-->java 폴더내 util폴더내 Scanner 클래스 가져온디
        // java.lang 패키지는 import 생략
