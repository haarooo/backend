...
인하세요.*/
        ...
        BankAccount1 account2 = new BankAccount1("123-456");
...
3. main 함수에서 CircleCalculator 객체를 생성하고, 반지름이 5인 원의 넓이를 출력하세요.*/
        ...
        CircleCalculator newCircle = new CircleCalculator();
        System.out.println(newCircle.printCircleArea(5));
...
총 발권 수가 올바르게 나오는지 확인하세요.*/
        ...
        System.out.println(TicketMachine.printTotalTickets());
...
class CircleCalculator{
    ...
    int r1;
    double printCircleArea(int r1){
        this.r1 = r1;
        double result = r1*r1*Pi;
...
class GameConfig{
    ...
    public static final String Game_Title = "MyRPG";
}
