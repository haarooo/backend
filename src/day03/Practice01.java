...
출력 예시: 성공 */
        ...
        System.out.print("점수1 : "); int score1 = scan.nextInt();
        System.out.print("점수 2: "); int score2 = scan.nextInt();
        if(score1+score2 >= 90){
...
두 번째 정수: 25
출력 예시: 더 큰 수: 25 */
        System.out.print("정수1 : "); int number1 = scan.nextInt();
        System.out.print("정수 2 : "); int number2 = scan.nextInt();
        if(number1 > number2){
...
출력 예시: 보안 등급: 강함 */
        ...
        System.out.print("비밀번호 : "); String pw1 = scan.nextLine();
        if(pw1.length() < 8 ) {
            System.out.println("8자 이상으로 설정해주세요");}
...
출력 예시: 여자 */
        ...
        System.out.print("주민번호 : "); String rnumber = scan.next();
        if(rnumber.charAt(7) == '1' || rnumber.charAt(7) == '3'){
            System.out.println("남자");
        }else if(rnumber.charAt(7) == '2' || rnumber.charAt(7) == '4'){
...
점수를 입력하세요: 750
출력 예시: B급 경품 */
        System.out.print("게임 점수 : "); int gameScore = scan.nextInt();
        if(gameScore >= 900){
...
출력 예시: 콘텐츠 수정 및 생성 기능에 접근할 수 있습니다. */
        ...
        System.out.print("사용자 역할 : "); String role = scan.next();
        switch (role){
            case "admin":
...
출력 예시: B등급 */
        ...
        System.out.print("성적 : "); int score = scan.nextInt();
        if(score >= 90){
...
출력 예시: 최종 결제 금액: 54000원 */
        ...
        System.out.print("총 구매 금액 : "); int money = scan.nextInt();
        double money1 = money;
        if(money >= 50000){
            System.out.println(money1=money*0.90);}
        else if(money >=30000){
            System.out.println(money1=(money*0.95));}
        else if(money >=10000){
            System.out.println(money1=(money*0.99));}
        else{
...
출력 예시: 가을 */
        ...
        System.out.print("월 :"); String month = scan.next();
        switch (month){
            case "3","4","5":
...
출력 예시: 가장 큰 수: 78 */
        ...
        System.out.print("첫번째숫자 입력 : "); int fnumber = scan.nextInt();
        System.out.print("두번째숫자 입력 : "); int snumber = scan.nextInt();
        System.out.print("세번째숫자 입력 : "); int tnumber = scan.nextInt();
        if(fnumber > snumber && fnumber > tnumber){
            System.out.println("가장 큰 수:" + fnumber);}
        else if(snumber > fnumber && snumber > tnumber){
            System.out.println("가장 큰 수:" + snumber);}
        else if(tnumber > fnumber && tnumber > snumber){
            System.out.println("가장 큰 수:" + tnumber);}
