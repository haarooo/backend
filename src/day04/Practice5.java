...
출력 예시:14까지 더했을 때 합계가 105로 100을 넘습니다.*/
        ...
        for(int i = 1 ; i<=50 ; i++){
            sum1+=i;
            if(sum1 >= 100){ System.out.println(i + "(순서):" + sum1);
            break;};
        }
...
4주차 : ■■■■■■■■■■■1173만원 */
        ...
        int july1 = 3532100/10000;
        int july2 = 9123700/10000;
        int july3 = 5183400/10000;
        int july4 = 11738700/10000;
...
프로그램을 종료합니다. */
        ...
        for(;;){
            ...
            if(num == 1){
                System.out.print("입금액>"); int inputMoney = scan.nextInt(); balance += inputMoney;
                System.out.println("입금성공");
                System.out.println("잔고 : " + balance);
            }else if(num ==2){
                System.out.print("출금액>");int outputMoney = scan.nextInt();
                if(outputMoney <= balance){balance-=outputMoney;}
                else{
